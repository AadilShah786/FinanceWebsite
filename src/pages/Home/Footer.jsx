...
function Footer() {
    return (
        <>
            <footer id="Footer" class=" border-t border-t-gray-500 mt-12">
                ...
                <div class=" pt-8">
                    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                        ...
                        <div class="border-t mt-4 py-8 text-center text-sm text-gray-400">© 2021 - Present Flowrift. All rights reserved.</div>
                    </div>
                </div>
            </footer>
        </>
